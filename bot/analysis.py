...
async def get_daily_briefing(market_data=None):
    try:
        ...
        system_prompt = f""" 
    Ты — главный аналитик крипто-фонда. 
    Твоя задача — просканировать рынок и найти кандидатов на ПАМП в секторах: AI, RWA, Layer-2, DePIN. 
 
    ВХОДНЫЕ ДАННЫЕ (Цены топ-активов): 
    {market_data_str} 
    ...
    Ты можешь использовать свои внутренние знания о монетах этих секторов (FET, ONDO, ARB, HNT и др), коррелируя их с общим рынком. 
 
    КРИТЕРИИ АНАЛИЗА: 
    1. Техника: Фаза аккумуляции, формирование дна, бычьи дивергенции. 
    2. Liquidity Hunter: Сбор стопов, ложные пробои. 
    ...
    💎 <b>AI Sector: [ТИКЕР]</b> 
    💵 <b>Цена:</b> $... 
    • <b>Техника:</b> (Почему вход?) 
    • <b>Следы ММ:</b> (Спуфинг, аккумуляция?) 
    • 🎯 <b>Сигнал:</b> LONG 
      └ Вход: $... 
      └ TP: $... / $... 
      └ SL: $... 
 
    💎 <b>RWA Sector: [ТИКЕР]</b> 
    (Аналогичный блок) 
 
    💎 <b>Layer-2 Sector: [ТИКЕР]</b> 
    (Аналогичный блок) 
 
    💎 <b>DePIN Sector: [ТИКЕР]</b> 
    (Аналогичный блок) 
    """
