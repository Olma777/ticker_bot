...
async def get_sniper_analysis(ticker, lang="ru"):
    ...
    Используешь стратегию "Liquidity Hunter 2.0" и "Smart Money Concepts" (SMC). 
    Твоя задача — найти снайперскую точку входа для {ticker} (USDT-M Futures). 
 
    ИСХОДНЫЕ ДАННЫЕ (ФАКТЫ - Futures Market): 
    ...
    Учитывай специфику фьючерсов: сквизы, ликвидации, фандинг.
 
    СТРУКТУРА ОТВЕТА (Строго Markdown): 
 
    # 📊 {ticker} (Futures) — Smart Money Setup 
    * **Цена сейчас:** ${price} 
    ...
    **Совет ММ:** (Психология сделки и риск на сделку) 
    """
